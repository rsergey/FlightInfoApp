...
<img src="/Screenshots/SelectionViewController.png" width="30%" height="30%">  
...
<img src="/Screenshots/SettingsViewController.png" width="30%" height="30%">  
...
<img src="/Screenshots/DetailsTableViewController.png" width="30%" height="30%">  
...
### StorageManager
Сервисный класс, реализующий работу с CoreData. Организованы методы чтения из базы, сохранения и очистки данных для перелётов и списка аэропортов.
